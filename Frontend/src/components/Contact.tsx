          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-2xl overflow-hidden shadow-lg">
              <div className="h-64 relative">
                <a
                  href="https://maps.google.com?q=E'lan%20Nails%20and%20Head%20Spa,%20Shop%205/57/61%20Emerald%20Dr,%20Regents%20Park%20QLD%204118"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <iframe
                    src="https://www.google.com/maps?q=E'lan%20Nails%20and%20Head%20Spa,%20Shop%205/57/61%20Emerald%20Dr,%20Regents%20Park%20QLD%204118&output=embed"
                    width="100%"
                    height="100%"
                    loading="lazy"
            ...
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-2xl overflow-hidden shadow-lg">
              <div className="h-64 relative">
                <a
                  href="https://maps.app.goo.gl/P73YEMG6GYuqFZax6"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <iframe
                    src="https://www.google.com/maps?q=1220%20Sandgate%20Rd,%20Nundah%20QLD%204012&output=embed"
                    width="100%"
                    height="100%"
                    loading="lazy"
                    referrerPolicy="no-referrer-when-downgrade"
